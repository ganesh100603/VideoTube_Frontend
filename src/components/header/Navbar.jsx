...
import {Search,Button,Logo,SearchForSmallScreen, Input} from ".."
    ...
    return(
        <>
            <nav className="w-full bg-[#0E0F0F] flex justify-between items-center p-4 sm:gap-5 gap-2 border-b-2 border-gray-500 sticky top-0 z-50 ">
                ...
                {toggleMenu&&(
                    <div className="fixed right-0 top-0 text-white flex flex-col border-1 h-screen w-[70%] bg-[#0F0F0F] 
                    sm:hidden rounded-lg outline-none">
                        ...
                        <div className="flex flex-col justify-between h-full py-5 px-3">
                            ...
                            {!authStatus?(
                                ...
                                <div className="flex gap-2 justify-start items-start cursor-pointer py-1 px-2 border border-slate-600"
                                onClick={()=>logout()}
                                >
                                    <MdLogout
                                    size={25}
