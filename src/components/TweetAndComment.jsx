...
function TweetAndComment({tweet,comment,videoId}){
    ...
    return(
        <>
            ...
            >
                <textarea
                placeholder={`${tweet ? "Write a post" : "Add a comment"}`}
                ...
                <Button
                type="submit"
                className="bg-purple-500 px-2 py-1 text-black hover:scale-110 transition-all ease-in absolute sm:bottom-8 sm:right-8 bottom-8
                right-4 text-xs sm:text-base"
                >
                    Send
                </Button>
            </form>
